...
public class Featured {
    public static class AccessibilityLabels {
        ...
        public static final String searchGroupon = "searchGroupon";
    }
    ...
    public void validateScreenElements() {
        Assert.assertEquals("featuredTab doesnt exist", AccessibilityLabels.featured + " label", featuredTab.getIdentifier());
        Assert.assertEquals("searchBar doesnt exist", AccessibilityLabels.searchGroupon + " text field", searchBar.getIdentifier());
    }
}
