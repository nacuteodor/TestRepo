...
public class Featured {
    ...
    public void validateScreenElements() {
        Assert.assertEquals ( "featuredTab doesn't exist", Featured.AccessibilityLabels.featured + " label", featuredTab.getIdentifier());
        Assert.assertEquals ( "searchBar doesn't exist", Featured.AccessibilityLabels.searchGroupon + " text field", searchBar.getIdentifier());
    }
